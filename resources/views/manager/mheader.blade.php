...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    </div><header style="background-image: url(/images/1.jpg);">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="/mhome" class="nav-link">Home</a></li>
            <li class="nav-item active"><a class="nav-link" href="/viewcust">View Customer</a></li>
